...
void Lab8::Init()
{
    ...
    // Light & material properties
    {
        ...
        materialKs = 0.5;
        cutoffAngle = 20.0f;
        lightPosition2 = glm::vec3(0, 1.5f, 1);
...
void Lab8::Update(float deltaTimeSeconds)
{
    ...
    // Render ground
    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["plane"], shaders["LabShader"], modelMatrix, glm::vec3(0, 0.5, 0));
...
//de transmis la render in shader ca uniform! 
    if (key == GLFW_KEY_F)
    {
        typeOfLight += 1;
    }
